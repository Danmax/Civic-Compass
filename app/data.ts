...
export const QUESTIONS: Question[] = [
  ...
  q(10, "immigration", "Long-term peaceful undocumented immigrants should have a way to become legal residents.", "A pathway may include background checks, fees, and other requirements.", "Compassion", [{ dimension: "global", weight: -0.7 }, { dimension: "change", weight: -0.2 }]),
  ...
  q(17, "immigration", "The country should offer more legal ways for people to immigrate.", "Think about visas, work permits, family applications, and other lawful pathways.", "Opportunity", [{ dimension: "global", weight: -0.8 }, { dimension: "markets", weight: 0.15 }]),
  ...
  q(21, "rights", "People should generally be able to use public restrooms that match their gender identity.", "Think about ordinary public restrooms; shelters, prisons, and sports may raise separate questions.", "Equal access", [{ dimension: "social", weight: -0.8 }, { dimension: "identity", weight: -0.55 }, { dimension: "change", weight: -0.35 }]),
  ...
  q(27, "family", "Religious and traditional families should be free to live by their values.", "This assumes they still respect the legal rights of others.", "Religious liberty", [{ dimension: "faith", weight: 0.8 }, { dimension: "liberty", weight: -0.6 }]),
  q(28, "rights", "Shelters and prisons should be allowed to consider biological sex when deciding where someone is housed.", "Other factors may include safety, risk, gender identity, and individualized review.", "Safety", [{ dimension: "social", weight: 0.55 }, { dimension: "identity", weight: 0.4 }, { dimension: "liberty", weight: 0.15 }]),
  ...
  q(33, "equal", "Organizations should review their rules to see if they unfairly block people from different backgrounds.", "Focus on reviewing access and fairness, not guaranteeing equal outcomes.", "Inclusion", [{ dimension: "identity", weight: -0.6 }, { dimension: "trust", weight: 0.2 }]),
  ...
  q(35, "rights", "Rules for sex-specific spaces should allow case-by-case decisions when safety or privacy is at stake.", "Think about whether one rule should always apply, or whether some cases need individual review.", "Context", [{ dimension: "identity", weight: -0.15 }, { dimension: "trust", weight: 0.25 }]),
  ...
  q(46, "family", "Public schools should spend more class time on reading, math, history, and job skills.", "Think about curriculum priorities across the school year.", "Educational basics", [{ dimension: "social", weight: 0.6 }, { dimension: "trust", weight: -0.25 }, { dimension: "change", weight: 0.2 }]),
  ...
  q(51, "family", "Public policy should encourage sexual responsibility when children or family stability could be affected.", "Think about education, public messages, incentives, and community standards rather than criminal punishment alone.", "Moral responsibility", [{ dimension: "faith", weight: 0.85 }, { dimension: "social", weight: 0.75 }, { dimension: "liberty", weight: 0.35 }]),
  ...
  q(55, "equal", "Public conversations about race should also consider why some people feel exhausted by constant racial conflict.", "This does not deny discrimination; it asks whether fatigue from the debate also deserves attention.", "Social trust", [{ dimension: "identity", weight: 0.1 }, { dimension: "trust", weight: 0.25 }, { dimension: "change", weight: 0.15 }]),
  ...
  q(58, "immigration", "Foreign policy should put American interests first, even when allies disagree.", "Think about trade, defense commitments, foreign aid, and diplomacy.", "National interest", [{ dimension: "global", weight: 0.9 }, { dimension: "trust", weight: -0.15 }]),
